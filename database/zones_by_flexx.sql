...
INSERT INTO `users` (`id`, `login`,  `user_ip`, `debit`, `credit`) VALUES
(2, 'test',  '192.168.8.1',  100, 100),
(3, 'batanik',  '192.168.8.3',  98.0986, 100),
(4, 'dread',  '192.168.8.4',  100, 100),
(5, 'misdoro',  '192.168.6.99', 99.7915, 100),
(6, 'vitalvann',  '192.168.8.5', 99.9881, 100),
(7, 'murad', '192.168.8.6Â ', 100, 100),
(8, 'big_ben',  '192.168.8.7',  98.1158, 100),
(9, 'pavlin', '192.168.8.8', 96.7951, 100),
(10, 'bill3',  '192.168.8.9', 99.7633, 100),
(11, 'michael', '192.168.8.10', 100, 100);
